 ...
 *    - Activity Types
 *    - Rank Types
 *    - Notify Actions (42 types from client)
 *    - Scheduler Config
 *    - Room Config
 * =====================================================
 */
 ...
 */
var SCHEDULER = {
    /** Daily reset time (hour of day, 24h format) */
    DAILY_RESET_HOUR: 6,
    /** Daily reset time (minute) */
    DAILY_RESET_MINUTE: 0,
    /** Stamina recovery interval in milliseconds */
    STAMINA_INTERVAL_MS: 5 * 60 * 1000,
    /** Maximum stamina */
    STAMINA_MAX: 120,
    /** Maximum hangup time in milliseconds (8 hours) */
    HANGUP_MAX_MS: 8 * 60 * 60 * 1000,
    /** Activity scheduler check interval in milliseconds */
    ACTIVITY_CHECK_MS: 30 * 1000,
    /** Battle cleanup interval in milliseconds */
    BATTLE_CLEANUP_MS: 5 * 60 * 1000,
    /** Login token expiry in milliseconds (24 hours) */
...
var ROOM_CONFIG = {
    ...
    MAX_ROOM_MEMBERS: 3,
    /** Room timeout before auto-disband (10 minutes) */
 ...
 */
var RECOVERY = {
    /** Stamina per 5 minutes */
    STAMINA_PER_TICK: 1,
    /** Milliseconds per stamina tick */
    STAMINA_TICK_MS: 5 * 60 * 1000,
    /** Maximum stamina cap */
    STAMINA_CAP: 120,
    /** Maximum AFK/hangup hours */
    HANGUP_MAX_HOURS: 8
};
