...
(function(window) {
    ...
    // ========================================================
    // EXPORT LOG FOR OTHER HANDLERS
    // ========================================================
    window.DUNGEON_SERVER_LOG = LOG;
    ...
    window.DUNGEON_SERVER_MOCK = {
        ...
        // Additional helpers for other handlers
        getServerTime: Helpers.getServerTime,
        buildResponse: Helpers.buildResponse,
        getTeams: Helpers.getTeamsData,
        saveTeams: Helpers.saveTeamsData,
        getUserTeam: Helpers.getUserTeam,
        saveUserTeam: Helpers.saveUserTeam,
        removeUserTeam: Helpers.removeUserTeam
    };
